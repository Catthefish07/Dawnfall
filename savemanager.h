...
{
public:
    void saveGame(int slot, PlayerRecord player, Inventory& iv, Shop& shop); // saves data of the whole game
    PlayerRecord loadGame(int slot, Inventory& iv, Shop& shop); // restores back data when player loads game
