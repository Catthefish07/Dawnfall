...
void SaveManager::saveGame(int slot, PlayerRecord player, Inventory& iv, Shop& shop, PartyManager& pm){
    ...
    vector<Character*> allCharacters = pm.getUnlockedCharacters(); // ensures unlocked charaacters in party
...
void SaveManager::loadInventory(Inventory& iv){
    ...
    file.read((char*)&coins, sizeof(int));
